...
class AstronomicalDataTest {
    ...
    @Test
    fun `getDayLength calculates correctly`() {
        // Given
    ...
    @Test
    fun `getDayProgress calculates correctly during daytime`() {
        // Given
        val sunrise = 1621476800L // 2021-05-20 06:00:00 UTC
        val sunset = 1621533600L  // 2021-05-20 22:00:00 UTC
    ...
    @Test
    fun `getDayProgress returns 0 before sunrise`() {
        // Given
        val sunrise = 1621476800L // 2021-05-20 06:00:00 UTC
        val sunset = 1621533600L  // 2021-05-20 22:00:00 UTC
    ...
    @Test
    fun `getDayProgress returns 100 after sunset`() {
        // Given
        val sunrise = 1621476800L // 2021-05-20 06:00:00 UTC
        val sunset = 1621533600L  // 2021-05-20 22:00:00 UTC
    ...
    @Test
    fun `fromWeatherResponse creates correct AstronomicalData`() {
        // Given
